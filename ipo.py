...
for i in range(48):
    ...
    for row in rows[1:]:
        ...
        for pdf in pdf_list:
            ...
            merger.append(pdf)
        merger.write("D:\Projects\scraps\ipo_data\ViewJournal.pdf")
        merger.close()
        name = issue[1].text.split('/')
        rename_ = 'D:\\Projects\\scraps\\ipo_data\\ '.strip()+ name[0] + '_' + name[1] + ".pdf"
        os.rename("D:\\Projects\\scraps\\ipo_data\\ViewJournal.pdf", rename_)
